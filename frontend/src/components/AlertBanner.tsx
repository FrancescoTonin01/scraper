      ...
      <AnimatePresence mode="wait">
        {state === "success" ? (
          ...
          <motion.div key="form" exit={{ opacity: 0 }}>
            <div className="flex min-w-0 items-start gap-3 mb-3 pr-5">
            ...
            <form onSubmit={handleSubmit} className="flex min-w-0 flex-col gap-2 sm:flex-row">
              <input
                ...
                className="w-full flex-1 min-w-0 px-3 py-2 text-sm rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-slate-400"
              />
              <button
                type="submit"
